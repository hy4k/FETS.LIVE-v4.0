    ...
    <div className="fixed inset-0 z-[2000] flex items-center justify-center bg-black/60 backdrop-blur-md">
      <motion.div
        ...
        className={`bg-[#0f172a] border-2 ${
          callType === "audio" ? "border-emerald-500" : "border-[#ffbf00]"
        } p-10 rounded-[40px] shadow-[0_0_120px_rgba(0,0,0,0.8)] max-w-sm w-full text-center relative overflow-hidden`}
      >
        {/* Background Ambience */}
        <div
          className={`absolute inset-0 bg-gradient-to-br ${
            callType === "audio" ? "from-emerald-500/10" : "from-[#ffbf00]/10"
        ...
        <div className="relative z-10 flex flex-col items-center">
          <div className="relative mb-8">
            <div
              className={`w-24 h-24 rounded-full flex items-center justify-center border-2 p-1 ${
                callType === "audio"
                  ? "border-emerald-500/50 shadow-[0_0_30px_rgba(16,185,129,0.3)]"
                  : "border-[#ffbf00]/50 shadow-[0_0_30px_rgba(255,191,0,0.3)]"
              }`}
            >
            ...
            <div
              className={`absolute -bottom-1 -right-1 p-2 rounded-full border-2 border-[#0f172a] ${
                callType === "audio"
            ...
            {profile?.branch_assigned && (
              <div className="flex items-center justify-center gap-1.5 text-white/40">
                ...
                <span className="text-[10px] font-bold uppercase tracking-widest">
                  {profile.branch_assigned} Branch
                </span>
              </div>
            )}
          </div>
