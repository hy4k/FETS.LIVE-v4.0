...
export const EnhancedRequestsModal: React.FC<RequestsModalProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<
    "create" | "my-requests" | "manage"
  >("create");
  const [requestType, setRequestType] = useState<"leave" | "shift_swap">(
    "leave"
  );
  ...
  const createRequest = async () => {
    ...
    try {
      ...
      toast.success(
        `${
          requestType === "leave" ? "Leave" : "Shift swap"
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder={`Please provide a reason for the ${
                    requestType === "leave" ? "leave" : "shift swap"
                  }...`}
                  rows={3}
              ...
              <button
                ...
                disabled={
                  loading ||
                  !selectedDate ||
                  (requestType === "shift_swap" && !selectedTargetStaff)
                }
                      ...
                      <div className="flex-1">
                        <div className="flex items-center space-x-2 mb-2">
                          ...
                          <span className="font-medium text-gray-900">
                            {request.request_type === "leave"
                              ? "Leave Request"
                              : `Shift Swap with ${request.target_name}`}
                          </span>
                          <span
