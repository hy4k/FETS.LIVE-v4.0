      ...
      <AnimatePresence>
        {callState.status !== "idle" && (
          <CallOverlay
            ...
            remoteUserName={
              callState.remoteUserName || targetUser.full_name || "Unknown"
            }
      ...
      >
        ...
        <div className="bg-[#f4d03f] px-4 py-3 flex items-center justify-between border-b-2 border-black cursor-move">
          <div className="flex items-center gap-2">
            ...
            <span className="font-black text-xs uppercase tracking-[0.2em] text-black italic">
              FETSCHAT //{" "}
              <span className="text-black/60">{targetUser.full_name}</span>
            </span>
          </div>
          <div className="flex items-center gap-2">
            <button
                      ...
                      {isMe && !isDeleted && (
                        <div className="absolute -top-2 -right-2 opacity-0 group-hover:opacity-100 transition-opacity flex gap-1">
                          ...
                          <button
                            onClick={() =>
                              setContextMenuMsgId(
                                msg.id === contextMenuMsgId ? null : msg.id
                              )
                            }
                        ...
                        <div className="flex flex-col gap-2">
                          ...
                          <div className="flex gap-2 justify-end">
                            <button
                              ...
                              className="text-[9px] font-black uppercase text-slate-500 hover:text-black"
                            >
                              Cancel
                            </button>
                            <button
                              onClick={() => handleEditMessage(msg.id)}
                              className="text-[9px] font-black uppercase text-amber-700 hover:text-amber-900"
                            >
                              Save
                            </button>
                          </div>
                        ...
                        <>
                          ...
                          {msg.type === "file" && (
                            <a
                              href={msg.content}
                              target="_blank"
                              className="flex items-center gap-2 text-xs font-black underline"
                            >
                              <FileText size={14} />{" "}
                              {msg.file_path || "Document"}
                            </a>
                          )}
                        </>
                      )}
              ...
              {isRecording ? (
                ...
                >
                  ...
                  <div className="flex items-center justify-between px-1">
                    ...
                    />
                    {isUploading && (
                      <div className="text-[10px] font-black text-amber-600 animate-pulse uppercase tracking-widest">
                        Encrypting...
                      </div>
                    )}
                  </div>
