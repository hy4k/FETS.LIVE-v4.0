          ...
          <div className="flex items-center gap-4">
            <div className="relative group">
              ...
              <div className="w-16 h-16 bg-[#111621] border border-white/10 rounded-2xl flex items-center justify-center relative z-10 shadow-xl overflow-hidden">
                <BrainCircuit
                  size={32}
                  className="text-emerald-400 transform group-hover:scale-110 transition-transform duration-500"
                />
            ...
            <div>
              <h1 className="text-4xl md:text-5xl font-black tracking-tighter text-white m-0 leading-none">
                FETS{" "}
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400 drop-shadow-[0_0_15px_rgba(52,211,153,0.3)] italic">
                  AI
                </span>
              </h1>
            ...
            {navTabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2 px-5 py-2.5 rounded-xl font-bold text-[11px] uppercase tracking-wider transition-all duration-300 whitespace-nowrap ${
                    isActive
                ...
                {messages.length === 0 ? (
                  <div className="h-full flex flex-col items-center justify-center text-center px-4 mt-8 md:mt-0">
                    <div className="w-24 h-24 bg-[#1A2234] border border-white/5 rounded-[2rem] flex items-center justify-center mb-6 shadow-2xl relative group cursor-default">
                      ...
                      <BrainCircuit
                        size={48}
                        className="text-emerald-400/80 group-hover:scale-110 group-hover:text-emerald-300 transition-all duration-500"
                      />
                    </div>
                    ...
                    <p className="text-slate-400 text-sm max-w-md mx-auto mb-10 font-medium tracking-wide leading-relaxed">
                      FETS AI processes all operational telemetry, candidates,
                      and historical incident logs. Enter a query below.
                    </p>
                  ...
                  messages.map((msg) => (
                    ...
                    >
                      <div
                        className={`max-w-[95%] md:max-w-[75%] p-5 rounded-3xl ${
                          msg.role === "user"
                      ...
                      >
                        ...
                        <div
                          className={`text-[10px] mt-4 font-bold uppercase flex items-center gap-2 ${
                            msg.role === "user"
                              ? "text-emerald-200/70 justify-end"
                              : "text-slate-500"
                          }`}
                        >
                  ...
                  >
                    <div className="bg-[#1A2234]/80 border border-white/10 px-6 py-5 rounded-3xl rounded-tl-sm shadow-xl backdrop-blur-md flex items-center gap-4">
                      <div className="flex gap-1.5">
                        <div
                          className="w-2 h-2 bg-emerald-400 rounded-full animate-bounce shadow-[0_0_8px_#34d399]"
            ...
            >
              ...
              <div className="text-center max-w-md">
                ...
                <p className="text-slate-400 font-medium leading-relaxed">
                  Direct dashboard telemetry is currently offline. Please use
                  the AI Nexus terminal to query exam statistics, candidate
                  counts, and analytical summaries.
                </p>
              </div>
            </motion.div>
          )}
          ...
          {activeTab === "knowledge" && (
            ...
            >
              ...
              <div className="text-center max-w-md">
                ...
                <p className="text-slate-400 font-medium leading-relaxed">
                  Access to raw records is restricted. To cross-reference
                  documentation or historical incidents, initiate a query
                  through the FETS AI terminal.
                </p>
              </div>
            </motion.div>
          )}
