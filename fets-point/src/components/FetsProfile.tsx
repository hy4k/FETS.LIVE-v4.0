    ...
    <div className="flex items-center gap-4 py-3 border-b border-white/5 last:border-0 group">
      ...
      <div className="flex-1">
        ...
        {isLink ? (
          <a
            href={value}
            className="text-sm font-medium text-amber-400 hover:text-amber-300 transition-colors truncate block"
          >
            {value}
          </a>
        ) : (
          ...
          >
            ...
            <div className="w-full h-full rounded-full overflow-hidden border-4 border-black/50 shadow-2xl relative z-10">
              <img
                src={
                  profile?.avatar_url ||
                  `https://ui-avatars.com/api/?name=${profile?.full_name}&background=f59e0b&color=000`
                }
                alt="Profile"
          ...
          {isEditingBio ? (
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar">
              <p className="text-sm text-gray-300 italic leading-relaxed">
                {bio ||
                  "No bio established. Click edit to add identity details."}
              </p>
            </div>
          )}
        </div>
        ...
        <div className="flex-1 rounded-3xl bg-white/[0.03] border border-white/10 shadow-2xl p-8 relative overflow-hidden">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              ...
              <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">
                Personnel Data File • Classified
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-x-12 gap-y-2">
            ...
            <InfoRow
              ...
              value={profile?.branch_assigned || "Global HQ"}
            />
            <InfoRow
              icon={Calendar}
          ...
          <div className="mt-8 pt-8 border-t border-white/5">
            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                <div
                  key={i}
                  className="px-3 py-1.5 rounded-lg bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-[10px] font-bold uppercase tracking-wider flex items-center gap-2 hover:bg-emerald-500/20 cursor-default transition-colors"
                >
                  <CheckMark /> {cert}
                </div>
              ))}
