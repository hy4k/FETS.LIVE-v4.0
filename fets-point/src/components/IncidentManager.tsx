...
import {
  ...
  getCategoryById,
  getCategoryColor,
} from "../config/caseCategories.config";
...
export default function IncidentManager() {
  ...
  useEffect(() => {
    const channel = supabase
      ...
      .on(
        ...
        (payload) => {
          if (payload.new.incident_id === selectedId)
  ...
  const handleSend = async (e?: React.FormEvent) => {
    ...
    if (toolMode === "contact") {
      ...
      payloadBody = JSON.stringify({
        task: inputData.task,
        assignee: inputData.assignee || "Unassigned",
        completed: false,
      });
    } else {
      ...
      return (
        <div className="ip-widget-card ip-widget-contact">
          ...
          <div className="ip-contact-details">
            ...
            <div className="ip-contact-row">
              <Phone className="w-3 h-3" /> {data?.phone}
            </div>
            <div className="ip-contact-row">
              <User className="w-3 h-3" /> {data?.role}
            </div>
          </div>
        </div>
      );
        ...
        <div className="ip-widget-card ip-widget-task">
          ...
          <div className="ip-task-body">
            ...
            <div>
              ...
              <div className="text-xs text-amber-700 uppercase mt-1">
    ...
    <div className="rac-page-container">
      ...
      <div className="rac-main-layout">
            ...
            {incidents.slice(0, 15).map((inc) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="rac-category-label">
                    CASE-{inc.id.slice(0, 6).toUpperCase()}
                  </span>
                  {isActive && (
                    <motion.div
              ...
              return (
                ...
                >
                  ...
                  <div className="rac-case-footer">
                    ...
                    >
                      <div
                        className="rac-status-dot"
                        style={{ background: statusConfig?.color }}
                      />
                      {statusConfig?.label}
                    </div>
                    <span className="rac-case-id">
                      CASE-{inc.id.slice(0, 6).toUpperCase()}
                    </span>
                  </div>
                </motion.div>
        ...
        <div className="rac-playground">
          {activeIncident ? (
            (() => {
              const activeCategoryConfig = getCategoryById(
                activeIncident.category
              );
              const ActiveCategoryIcon = activeCategoryConfig?.icon || Activity;
              const activeCategoryColors = getCategoryColor(
                activeIncident.category
              );
              const activeDisplayStatus = getDisplayStatus(
                activeIncident.status
              );
              const activeStatusConfig = STATUS_OPTIONS.find(
                (s) => s.value === activeDisplayStatus
              );
                    ...
                    <div className="rac-case-header-top">
                      <div className="rac-case-header-info">
                        <div
                          ...
                          style={{
                            background: `linear-gradient(135deg, ${activeCategoryColors.color}, ${activeCategoryColors.color}cc)`,
                          }}
                        >
                          <ActiveCategoryIcon
                            size={24}
                        ...
                        <div>
                          <div
                            ...
                            style={{
                              background: activeCategoryColors.bgColor,
                              color: activeCategoryColors.color,
                            }}
                          >
                          ...
                          {editMode ? (
                            ...
                            <h2 className="rac-case-title-large">
                  ...
                  <div className="ip-canvas custom-scrollbar">
                    ...
                    {comments.map((comment) => {
                      ...
                      return (
                        <div
                          key={comment.id}
                          className={`ip-widget-row ${isMe ? "right" : ""}`}
                        >
                          {!isMe && (
                            <div
                              className="ip-avatar"
                              title={comment.author_full_name}
                            >
                    ...
                    <div className="ip-dock">
                      ...
                      {toolMode === "contact" && (
                        <div className="grid grid-cols-3 gap-3 bg-slate-50 p-4 rounded-xl border border-slate-200">
                          <input
                            placeholder="Name (e.g. Repair Shop)"
                      ...
                      {toolMode === "task" && (
                        <div className="grid grid-cols-3 gap-3 bg-amber-50 p-4 rounded-xl border border-amber-200">
                          ...
                          <div className="flex gap-2">
                            ...
                            <button
                              onClick={() => handleSend()}
                              className="bg-amber-600 text-white rounded px-4 font-bold"
                            >
                              Assign
                            </button>
                          </div>
            ...
            <div className="rac-empty-state">
              ...
              <p className="rac-empty-subtitle">
                Choose a case from the list to view details and collaborate
              </p>
            </div>
          )}
        </div>
