...
export function MobileAiChat() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { id: '1', text: "Hello! I am FETS OMNI. How can I assist with your operations today?", sender: 'ai', timestamp: new Date() }
  ]);
    ...
    <div className="flex flex-col h-screen bg-[#0F172A] pb-32 pt-safe overflow-hidden">
      ...
      <div className="px-6 pt-8 pb-6 border-b border-white/10 flex items-center justify-between bg-[#0F172A]/80 backdrop-blur-xl relative z-10">
        <div className="flex items-center gap-4">
           ...
           <div>
              <h1 className="text-white font-black text-lg leading-none tracking-tight uppercase">FETS OMNI</h1>
         ...
         {messages.map((msg, i) => (
           ...
           >
             <div className={`max-w-[85%] flex flex-col ${msg.sender === 'user' ? 'items-end' : 'items-start'}`}>
                {msg.sender === 'ai' && (
                  <span className="text-[8px] font-black text-indigo-400 uppercase tracking-[0.2em] mb-2 ml-4">OMNI AI</span>
                )}
                <div className={`px-6 py-4 rounded-[32px] text-sm leading-relaxed shadow-xl ${
                  msg.sender === 'user' 
      ...
      <div className="px-6 py-8 bg-[#0F172A] border-t border-white/5 relative z-20">
         <div className="relative group">
            ...
            <div className="relative bg-[#1E293B] rounded-[30px] flex items-center p-2 shadow-2xl border border-white/5">
               ...
               <input 
                 type="text"
                 placeholder="Message OMNI Intelligence..."
                 value={input}
