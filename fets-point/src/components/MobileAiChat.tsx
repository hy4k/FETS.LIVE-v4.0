...
export function MobileAiChat() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      text: "Hello! I am FETS AI. How can I assist with your operations today?",
      sender: "ai",
      timestamp: new Date(),
    },
  ]);
    ...
    <div className="flex flex-col h-screen bg-[#0F172A] pb-32 pt-safe overflow-hidden">
      ...
      <div className="px-6 pt-8 pb-6 border-b border-white/10 flex items-center justify-between bg-[#0F172A]/80 backdrop-blur-xl relative z-10">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-white font-black text-lg leading-none tracking-tight uppercase">
              FETS AI
            </h1>
            <div className="flex items-center gap-1.5 mt-1.5">
              <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
              <span className="text-emerald-500/80 text-[9px] font-black uppercase tracking-widest">
                Neural Link Active
              </span>
            </div>
          </div>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="p-3 rounded-2xl bg-amber-500/10 text-amber-500 border border-amber-500/20 active:scale-95 transition-all"
          >
            <Smartphone size={20} />
          </button>
      ...
      >
        {messages.map((msg, i) => (
          ...
          >
            ...
            >
              {msg.sender === "ai" && (
                <span className="text-[8px] font-black text-indigo-400 uppercase tracking-[0.2em] mb-2 ml-4">
                  FETS AI
                </span>
              )}
              <div
                className={`px-6 py-4 rounded-[32px] text-sm leading-relaxed shadow-xl ${
                  msg.sender === "user"
          ...
          >
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-center gap-12">
              ...
              <div className="space-y-4">
                ...
                <p className="text-slate-400 text-sm font-medium leading-relaxed max-w-[280px] mx-auto uppercase tracking-widest opacity-60">
                  Authorize FETSAI to perform secure operations on this device.
                </p>
              </div>
