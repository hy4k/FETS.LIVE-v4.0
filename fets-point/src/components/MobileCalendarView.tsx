    ...
    <div className="flex flex-col min-h-screen bg-[#F0F2F5] pb-32 pt-safe">
      ...
      <div className="bg-[#F6C845] px-6 pt-10 pb-12 rounded-b-[40px] shadow-lg relative overflow-hidden sticky top-0 z-50">
        ...
        <div className="relative z-10 flex items-center justify-between mb-8">
          <div>
            <h1 className="text-[#3E2723] font-black text-2xl tracking-tighter leading-none uppercase italic">
              Exam Grid
            </h1>
            <p className="text-[#3E2723]/40 text-[10px] font-black uppercase tracking-[0.3em] mt-1.5">
              FETS Operational Calendar
            </p>
          </div>
        ...
        <div className="relative z-10 flex items-center justify-between mb-10 bg-white/30 backdrop-blur-xl p-2 rounded-[24px] border border-white/40 shadow-inner">
          <button
            ...
            className="w-12 h-12 rounded-2xl bg-white shadow-xl flex items-center justify-center text-[#3E2723] active:scale-95 transition-all"
          >
            <ChevronLeft size={24} />
          </button>
          <h2 className="text-sm font-black text-[#3E2723] uppercase tracking-[0.2em]">
              ...
              >
                <span
                  className={`text-[8px] font-black uppercase tracking-widest mb-1 ${
                    isSelected ? "text-amber-400" : "text-[#3E2723]/40"
                  }`}
                >
                  {format(date, "EEE")}
                </span>
                  ...
                  <div className="mt-2 flex flex-col items-center gap-0.5">
                    ...
                    <span
                      className={`text-[7px] font-black ${
                        isSelected ? "text-white/40" : "text-slate-300"
                      }`}
                    >
                      {
                        sessions.filter(
          ...
          <AnimatePresence mode="popLayout">
            {loading ? (
              [1, 2, 3].map((i) => (
                <div
                  key={i}
                  className="w-full h-32 bg-white rounded-[45px] border border-slate-50 animate-pulse shadow-sm"
                ></div>
              ))
                ...
                >
                  <div className="flex justify-between items-center relative z-10">
                    <div className="flex items-center gap-5">
                      ...
                      <div>
                        <h3 className="font-black text-slate-900 text-xl tracking-tight leading-none mb-1.5 truncate max-w-[180px] uppercase italic">
                          {session.client_name}
                        </h3>
              ...
              <div className="text-center py-20 bg-white/50 rounded-[60px] border-2 border-dashed border-slate-200">
                ...
                <p className="text-slate-300 text-[10px] font-bold uppercase mt-3 tracking-widest leading-relaxed">
                  System is clear for
                  <br />
