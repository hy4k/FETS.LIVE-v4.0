      ...
      <div className="bg-[#F6C845] px-6 pt-6 pb-12 rounded-b-[45px] shadow-lg relative overflow-hidden">
        ...
        <div className="relative z-10 flex justify-between items-center mb-10">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-2xl bg-white shadow-xl flex items-center justify-center border-2 border-white">
              <img
          ...
          <div className="flex items-center gap-2 px-4 py-2 bg-[#3E2723]/10 rounded-2xl border border-[#3E2723]/10">
          ...
          <div className="grid grid-cols-1 gap-4 px-2">
            ...
            >
              <div className="flex items-center gap-5">
                ...
                <div className="text-left">
                  <h3 className="text-slate-900 font-black text-xl tracking-tighter leading-none mb-1">
                    Register
                  </h3>
            ...
            >
              <div className="flex items-center gap-6 relative z-10">
                ...
                <div className="text-left">
                  <h3 className="text-white font-black text-xl tracking-tighter leading-none mb-1.5">
                    Access Hub
                  </h3>
              ...
              <div className="grid grid-cols-3 gap-4">
                {quickLinks.map((link) => (
                  ...
                  >
                    ...
                    <span className="text-[9px] font-black text-slate-500 group-active:text-amber-700">
                      {link.name}
                    </span>
                  </a>
                ))}
        ...
        <div className="space-y-5 pb-10">
          <div className="flex justify-between items-center px-2">
            ...
            <button
              ...
              className="text-amber-600 text-[10px] font-black uppercase tracking-widest"
            >
              Enter Desk
            </button>
          </div>
          ...
          >
            ...
            <div className="text-left flex-1">
              <h3 className="text-slate-900 font-black text-lg tracking-tighter leading-none mb-1.5">
                My Desk
              </h3>
              <p className="text-slate-400 text-[10px] font-bold uppercase tracking-widest leading-none">
                Team Feed & Active Stories
              </p>
            </div>
