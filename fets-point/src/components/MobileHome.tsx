...
export function MobileHome({
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#F0F2F5] pb-32 pt-safe">
      {/* PREMIUM APP HEADER */}
      <div className="bg-[#F6C845] px-6 pt-6 pb-12 rounded-b-[45px] shadow-lg relative overflow-hidden">
        ...
        <div className="relative z-10 flex justify-between items-center mb-10">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-2xl bg-white shadow-xl flex items-center justify-center border-2 border-white overflow-hidden">
              <img
            ...
            <div>
              <h1 className="text-[#3E2723] font-black text-2xl tracking-tighter leading-none italic uppercase">
                FETS LIVE
              </h1>
              <p className="text-[#3E2723]/40 text-[10px] font-black uppercase tracking-[0.3em] mt-1">
                Command Suite
              </p>
            </div>
          </div>
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-[#3E2723]/10 rounded-2xl border border-[#3E2723]/10 active:scale-95 transition-transform"
          >
            <Globe size={14} className="text-[#3E2723]/60" />
            <span className="text-[#3E2723] font-black text-[10px] uppercase tracking-widest">
              {activeBranch}
            </span>
            <ChevronDown size={12} className="text-[#3E2723]/40" />
          </button>
        </div>
        ...
        <div className="bg-white/95 backdrop-blur-xl p-5 rounded-[32px] shadow-2xl flex items-center justify-between border border-white">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-slate-400 text-[10px] font-black uppercase tracking-[0.2em] leading-none mb-1.5">
                Authorized Officer
              </p>
          ...
          <button
            ...
            className="w-10 h-10 rounded-2xl bg-slate-50 flex items-center justify-center text-slate-400"
          >
            <Shield size={20} />
          </button>
        </div>
            ...
            >
              <div
                className={`w-14 h-14 rounded-2xl flex items-center justify-center shadow-xl ${
                  todayStatus.post === "completed"
                    ? "bg-emerald-500 text-white shadow-emerald-100"
                    : "bg-[#3E2723] text-white shadow-[#3E2723]/10"
                }`}
              >
                <CheckCircle size={28} />
              </div>
        ...
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-2 gap-5">
            {coreModules.map((module) => (
              ...
              >
                <div
                  className={`${module.color} w-14 h-14 rounded-[22px] flex items-center justify-center text-white shadow-lg`}
                >
                  <module.icon size={28} />
                </div>
                <div>
                  <h3 className="font-black text-sm text-slate-800 leading-none mb-1.5 uppercase">
                    {module.label}
                  </h3>
            ...
            {secondaryModules.map((item) => (
              ...
              >
                <div className="flex items-center gap-5">
                  <div
                    className={`p-3 rounded-2xl bg-slate-50 ${item.color} group-active:scale-110 transition-transform`}
                  >
                    <item.icon size={22} />
                  </div>
                  <div className="text-left">
                    <h3 className="font-black text-slate-800 text-sm uppercase tracking-tight leading-none mb-1">
                      {item.label}
                    </h3>
          ...
          <div className="grid grid-cols-1 gap-4 px-2">
            ...
            >
              <div className="flex items-center gap-6 relative z-10">
                ...
                <div className="text-left">
                  <h3 className="text-white font-black text-xl tracking-tighter leading-none mb-1.5 uppercase italic">
                    F-Vault
                  </h3>
                  <p className="text-amber-500/60 text-[10px] font-bold uppercase tracking-widest leading-none">
                    Global Credentials
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white p-8 rounded-[45px] shadow-md border border-white">
              <div className="flex justify-between items-center mb-8 px-2">
                <div>
                  <h3 className="font-black text-slate-900 text-sm tracking-tight leading-none uppercase">
                    Portal Launchpad
                  </h3>
                  <p className="text-[9px] font-bold text-slate-300 uppercase tracking-widest mt-1">
                    Verified Gateways Only
                  </p>
                </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                {quickLinks.map((link) => (
                  ...
                  >
                    ...
                    <span className="text-[9px] font-black text-slate-500 group-active:text-amber-700 leading-none text-center">
                      {link.name}
                    </span>
                  </a>
                ))}
          ...
          <div className="pt-2 pb-10">
            ...
            >
              <div className="flex items-center gap-4 relative z-10">
                ...
                <div className="text-left">
                  <span className="font-black text-white text-lg uppercase tracking-tight block leading-none mb-1">
                    Admin Console
                  </span>
