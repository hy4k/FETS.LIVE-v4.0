...
export const ShiftCellPopup: React.FC<ShiftCellPopupProps> = ({
  ...
  const getCellPreview = () => {
    ...
    const shiftInfo =
      SHIFT_OPTIONS[selectedShift as keyof typeof SHIFT_OPTIONS];
    if (!shiftInfo)
      return { bg: "#f3f4f6", text: "#9ca3af", display: selectedShift };
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div
        className={`relative w-full overflow-hidden transform transition-all duration-300 scale-100 ${
          isMobile
      ...
      >
        ...
        <div
          className={`${
            isMobile ? "px-6 pt-12 pb-6" : "px-8 py-6"
          } bg-gradient-to-r from-gray-50/90 to-gray-100/90 border-b border-gray-200/50 flex-none`}
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900 tracking-wide uppercase italic tracking-tighter">
                  {staffName}
                </h3>
        ...
        <div
          className={`${
            isMobile ? "px-6 py-8" : "px-8 py-6"
          } space-y-8 flex-1 overflow-y-auto no-scrollbar`}
        >
          {/* Shift Selector Grid */}
          <div>
            <label className="block text-[10px] font-black text-slate-400 mb-6 tracking-[0.3em] uppercase italic">
          ...
          {/* Overtime Hours */}
          <div>
            <label className="block text-[10px] font-black text-slate-400 mb-4 tracking-[0.3em] uppercase italic">
            ...
            <div className="relative">
              <input
                ...
                value={overtimeHours}
                onChange={(e) =>
                  setOvertimeHours(parseFloat(e.target.value) || 0)
                }
                ...
                placeholder="0"
              />
              <div className="absolute right-8 top-1/2 -translate-y-1/2 text-sm text-slate-300 font-black uppercase tracking-widest">
                hours
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#3E2723] p-8 rounded-[40px] shadow-2xl relative overflow-hidden">
            ...
            <div className="text-[9px] font-black text-amber-500/50 mb-6 tracking-[0.4em] uppercase text-center">
              Protocol Preview
            </div>
        ...
        <div
          className={`${
            isMobile ? "px-6 py-8 pb-12" : "px-8 py-6"
          } bg-white border-t border-slate-50 flex-none`}
        >
