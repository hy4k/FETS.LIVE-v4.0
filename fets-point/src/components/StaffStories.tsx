              ...
              <div className="w-full h-full rounded-full bg-slate-100 border-2 border-white overflow-hidden p-1">
                <img
                  src={
                    ...
                    `https://ui-avatars.com/api/?name=${user?.user_metadata?.full_name}&background=0F172A&color=EAB308`
                  }
              ...
              <motion.div whileHover={{ scale: 1.05 }} className="relative">
                <div
                  className={`w-16 h-16 rounded-full p-[2px] ${
                    isOnline
                      ? "bg-gradient-to-tr from-rose-500 via-amber-500 to-purple-600 animate-spin-slow"
                      : "bg-slate-200"
                  }`}
                >
