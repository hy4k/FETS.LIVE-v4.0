      ...
      >
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3
                className={`text-[11px] font-black uppercase tracking-[0.2em] ${config.text}`}
              >
                {config.title}
              </h3>
          ...
          <div className="flex flex-col">
            ...
            <div className="relative border-b border-white/5 group/input">
              <div className="flex items-center gap-3 p-3">
                <Plus
                  size={16}
                  className={`flex-shrink-0 ${config.text} opacity-30`}
                />
                <input
                  type="text"
                  value={inputs[quad]}
                  onChange={(e) =>
                    setInputs({ ...inputs, [quad]: e.target.value })
                  }
                  onKeyDown={(e) => {
              ...
              <div
                className={`absolute bottom-0 left-0 h-[2px] bg-gradient-to-r ${config.bg.replace(
                  "/5",
                  ""
                )} to-transparent w-0 group-focus-within/input:w-full transition-all duration-500`}
              />
            </div>
          </div>
        </div>
