...
const PERMISSION_KEYS = [
  {
    ...
    icon: Users,
    description: "Create and edit staff rosters",
  },
  {
    key: "user_management_edit",
    label: "User Management Authority",
    icon: Shield,
    description: "Manage user profiles, roles and critical permissions",
  },
];
...
export function UserManagement() {
  ...
  const [activeTab, setActiveTab] = useState<
    "profile" | "employment" | "growth" | "permissions"
  >("profile");
  ...
  useEffect(() => {
    if (selectedUser) {
      ...
      setPermissions(
        (selectedUser.permissions as Record<string, boolean>) || {}
      );
  ...
  const filteredStaff = useMemo(() => {
    return staff.filter((s) => {
      ...
      const matchesBranch =
        branchFilter === "all" || s.branch_assigned === branchFilter;
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setSelectedUser((prev) =>
        prev ? { ...prev, ...formData, permissions } : null
      );
    } catch (error: any) {
  ...
  const handleArrayItemAdd = (
    field: "certificates" | "trainings_attended" | "future_trainings",
    value: string
  ) => {
    ...
    setFormData({
      ...
      [field]: [
        ...currentArray,
        { id: Date.now(), title: value, date: new Date().toISOString() },
      ],
    });
  };
  ...
  const isSuperAdmin =
    ...
    currentUser?.email === "mithun@fets.in";
  ...
  return (
    <div
      className="min-h-screen -mt-32 pt-48 px-6 md:px-8 pb-8"
      style={{ background: THEME.bgPrimary }}
    >
      <style>{`
      ...
      <div>
        {mainTab === "users" ? (
          <div
            ...
            style={{ minHeight: "600px", maxHeight: "calc(100vh - 280px)" }}
          >
              ...
              {selectedUser ? (
                ...
                >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      >
                        ...
                        <span className="flex items-center gap-1.5 text-sm">
                          <MapPin size={14} />{" "}
                          {formatBranchName(
                            formData.branch_assigned || "global"
                          )}
                        </span>
                      </div>
                    </div>
                  ...
                  <div
                    ...
                    style={{ borderColor: THEME.border }}
                  >
                    {["profile", "employment", "growth", "permissions"].map(
                      (tab) => (
                        <button
                          key={tab}
                      ...
                      {activeTab === "employment" && (
                        <div className="grid grid-cols-2 gap-5">
                          ...
                          <SelectField
                            ...
                            onChange={(v) =>
                              setFormData({ ...formData, branch_assigned: v })
                            }
                            options={[
                        ...
                        <div className="space-y-6">
                          {[
                            ...
                            <GrowthCard
                              ...
                              onAdd={(v) =>
                                handleArrayItemAdd(section.field as any, v)
                              }
                              onRemove={(idx) =>
                                handleArrayItemRemove(section.field as any, idx)
                              }
                            />
                          ))}
                              ...
                              <button
                                ...
                                style={{
                                  background: isEnabled
                                    ...
                                    : THEME.bgTertiary,
                                  border: `1px solid ${
                                    isEnabled ? THEME.gold + "40" : THEME.border
                                  }`,
                                }}
                              >
                                <div
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-1 py-3.5 rounded-xl font-semibold disabled:opacity-50"
              style={{ background: THEME.gold, color: THEME.bgPrimary }}
            >
