...
export const ChecklistCreator: React.FC<ChecklistCreatorProps> = ({
  onCancel,
  onSuccess,
  currentUser,
  initialData,
  ...
  const neumorphicClass =
    "bg-[#e0e5ec] shadow-[9px_9px_16px_rgb(163,177,198,0.6),-9px_-9px_16px_rgba(255,255,255,0.5)] rounded-xl border border-white/20";
  ...
  const neumorphicBtn =
    "px-6 py-2 rounded-xl font-medium transition-all active:scale-95 active:shadow-[inset_4px_4px_8px_rgba(163,177,198,0.6),inset_-4px_-4px_8px_rgba(255,255,255,0.5)] shadow-[6px_6px_10px_rgba(163,177,198,0.6),-6px_-6px_10px_rgba(255,255,255,0.5)] bg-[#e0e5ec] text-gray-700 hover:text-blue-600";
          ...
          {watch("questions").map((q, idx) => (
            <div key={idx} className={`p-6 ${neumorphicClass}`}>
              ...
              {q.type === "text" && (
                <input
                  type="text"
                  className={`w-full p-3 ${neumorphicInset} outline-none`}
              ...
              {q.type === "checkbox" && (
                <div className="flex items-center">
                  ...
                  <span className="text-gray-600">Check this box</span>
                </div>
              )}
              ...
              {q.type === "date" && (
                <input
                  type="date"
                  className={`p-3 ${neumorphicInset} outline-none`}
                  disabled
                />
              )}
            </div>
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-500 mt-1">
            Design a new protocol for your team
          </p>
        </div>
        <div className="flex space-x-4">
          <button
            onClick={() => setIsPreviewMode(true)}
            className={`${neumorphicBtn} text-blue-600`}
          >
            <Eye className="w-5 h-5 mr-2 inline" /> Preview
          </button>
          <button
            onClick={onCancel}
            className={`${neumorphicBtn} text-red-500`}
          >
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className={`w-full p-3 ${neumorphicInset} outline-none bg-transparent`}
                placeholder="e.g., Morning Opening Protocol"
              />
              {errors.title && (
        ...
        <div>
          ...
          <textarea
            ...
            className={`w-full p-3 ${neumorphicInset} outline-none bg-transparent h-24`}
        ...
        <div className="mt-8">
          ...
          <div className="space-y-6">
            {fields.map((field, index) => (
              <div
                key={field.id}
                className={`p-6 ${neumorphicClass} relative group transition-all hover:scale-[1.01]`}
              >
                  ...
                  <div className="md:col-span-11 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        <select
                          {...register(
                            `questions.${index}.attachment_mode` as const
                          )}
                          className={`w-full p-3 ${neumorphicInset} outline-none bg-transparent text-sm`}
                        >
                    ...
                    {(watch(`questions.${index}.type`) === "dropdown" ||
                      watch(`questions.${index}.type`) === "radio") && (
        ...
        <div className="flex justify-end pt-8">
          <button
            type="submit"
            className={`${neumorphicBtn} bg-green-50 text-green-600 text-lg px-8 py-3`}
          >
