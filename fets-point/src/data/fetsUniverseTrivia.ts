...
export const FETS_UNIVERSE_TRIVIA: FetsTriviaQuestion[] = [
  {
    ...
    correctAnswer: 1,
    context:
      "FETS.CASH is designed to streamline day-to-day operational expenses and petty cash management across branches.",
  },
  {
    id: "2",
    ...
    correctAnswer: 2,
    context:
      "FETS.IN serves as the central hub for student interactions, course materials, and academic records.",
  },
  {
    id: "3",
    ...
    correctAnswer: 2,
    context:
      "FETS.SPACE is the conceptual and visual representation of our digital ecosystem and future frontiers.",
  },
  {
    id: "4",
    ...
    correctAnswer: 1,
    context:
      "FETS.LIVE is the heartbeat of real-time operations, tracking staff, candidates, and immediate tasks.",
  },
];
