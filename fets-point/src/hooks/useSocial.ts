  ...
  return useMutation({
    mutationFn: async (file: File) => {
      ...
      if (uploadError) {
        ...
        toast.error(
          "Image upload failed. Creating bucket... Please run CREATE-STORAGE-BUCKET.bat"
        );
        throw new Error(
          'No storage bucket available. Please create "post-images" bucket in Supabase Storage.'
        );
      }
