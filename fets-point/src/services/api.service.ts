...
export const candidatesService = {
  async getAll(filters?: {
    ...
    try {
      ...
      if (filters?.date) {
        query = query
          .gte("exam_date", `${filters.date}T00:00:00Z`)
...
export const rosterService = {
  async getSchedules(filters?: { date?: string; profile_id?: string }) {
    try {
      let query = supabase.from("roster_schedules").select(`
          *,
      ...
      if (error instanceof ApiError) throw error;
      throw new ApiError(
        "Failed to fetch roster schedules",
        "FETCH_ERROR",
        error
      );
    }
  ...
  async create(schedule: TablesInsert<"roster_schedules">) {
    try {
      ...
      if (error instanceof ApiError) throw error;
      throw new ApiError(
        "Failed to create roster schedule",
        "CREATE_ERROR",
        error
      );
    }
  ...
  async update(id: string, updates: TablesUpdate<"roster_schedules">) {
    try {
      ...
      if (error instanceof ApiError) throw error;
      throw new ApiError(
        `Failed to update roster schedule ${id}`,
        "UPDATE_ERROR",
        error
      );
    }
  ...
  async delete(id: string) {
    try {
      ...
      if (error instanceof ApiError) throw error;
      throw new ApiError(
        `Failed to delete roster schedule ${id}`,
        "DELETE_ERROR",
        error
      );
    }
...
export const staffService = {
  ...
  async getById(id: string) {
    try {
      ...
      if (error instanceof ApiError) throw error;
      throw new ApiError(
        `Failed to fetch staff profile ${id}`,
        "FETCH_ERROR",
        error
      );
    }
  ...
  async update(id: string, updates: TablesUpdate<"staff_profiles">) {
    try {
      ...
      if (error instanceof ApiError) throw error;
      throw new ApiError(
        `Failed to update staff profile ${id}`,
        "UPDATE_ERROR",
        error
      );
    }
  ...
  async delete(id: string) {
    try {
      ...
      if (error instanceof ApiError) throw error;
      throw new ApiError(
        `Failed to delete staff profile ${id}`,
        "DELETE_ERROR",
        error
      );
    }
...
export const vaultService = {
  async getCategories() {
    try {
      ...
      if (error instanceof ApiError) throw error;
      throw new ApiError(
        "Failed to fetch vault categories",
        "FETCH_ERROR",
        error
      );
    }
  ...
  async createCategory(category: any) {
    try {
      ...
      if (error instanceof ApiError) throw error;
      throw new ApiError(
        "Failed to create vault category",
        "CREATE_ERROR",
        error
      );
    }
  ...
  async updateCategory(id: string, updates: any) {
    try {
      ...
      if (error instanceof ApiError) throw error;
      throw new ApiError(
        `Failed to update vault category ${id}`,
        "UPDATE_ERROR",
        error
      );
    }
  ...
  async deleteCategory(id: string) {
    try {
      ...
      if (error instanceof ApiError) throw error;
      throw new ApiError(
        `Failed to delete vault category ${id}`,
        "DELETE_ERROR",
        error
      );
    }
  ...
  async getItems(filters?: {
    ...
    try {
      ...
      if (filters?.searchQuery) {
        query = query.or(
          `title.ilike.%${filters.searchQuery}%,description.ilike.%${filters.searchQuery}%,content.ilike.%${filters.searchQuery}%`
        );
      }
  ...
  async updateItem(id: string, updates: any) {
    try {
      ...
      if (error instanceof ApiError) throw error;
      throw new ApiError(
        `Failed to update vault item ${id}`,
        "UPDATE_ERROR",
        error
      );
    }
  ...
  async deleteItem(id: string) {
    try {
      ...
      if (error instanceof ApiError) throw error;
      throw new ApiError(
        `Failed to delete vault item ${id}`,
        "DELETE_ERROR",
        error
      );
    }
...
export const brainstormService = {
  ...
  async getSessions(branchLocation?: string) {
    try {
      ...
      if (branchLocation && branchLocation !== "global") {
        query = query.or(
          `branch_location.eq.${branchLocation},branch_location.eq.global`
        );
      }
      ...
      if (error instanceof ApiError) throw error;
      throw new ApiError(
        "Failed to fetch brainstorm sessions",
        "FETCH_ERROR",
        error
      );
    }
  ...
  async createSession(session: {
    ...
    try {
      ...
      if (error instanceof ApiError) throw error;
      throw new ApiError(
        "Failed to create brainstorm session",
        "CREATE_ERROR",
        error
      );
    }
